                        ...
                        <div class="eForm-layouts">
                            <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('admin.school.update') }}">
                                ...
                                <div class="fpb-7">
                                    ...
                                    <textarea class="form-control eForm-control" id="email_details" name="email_details" rows="4"  maxlength="100"  required>{{ $school_details->email_details }}</textarea>
                                ...
                                <div class="fpb-7">
                                    ...
                                    <textarea class="form-control eForm-control" id="warning_text" name="warning_text" rows="3"  maxlength="60"  required>{{ $school_details->warning_text }}</textarea>
                                ...
                                <div class="fpb-7">
                                    ...
                                    <input type="text" class="form-control eForm-control" value="{{ $school_details->socialLink1 }}" id="socialLink1" name = "socialLink1" placeholder="https://" required>
                                </div>
                                <div class="fpb-7">
                                    <label for="school_info" class="eForm-label">{{ get_phrase('Social Link 2') }}</label>
                                    <input type="text" class="form-control eForm-control" value="{{ $school_details->socialLink2 }}" id="socialLink2" name = "socialLink2" placeholder="https://" required>
                                </div>
                                <div class="fpb-7">
                                    <label for="school_info" class="eForm-label">{{ get_phrase('Social Link 3') }}</label>
                                    <input type="text" class="form-control eForm-control" value="{{ $school_details->socialLink3 }}" placeholder="https://" id="socialLink3" name = "socialLink3" required>
                                </div>
                                <div class="row mt-4">
              ...
              <div class="row mt-2">
                <div class="col-md-12">
                  <div class="alert alert-success" role="alert">
                    <small>{{ get_phrase("Only the server will support email logos and social media icons.Localhost won't support this.") }}</small>
                  </div>
                </div>
              </div>
            </div>
