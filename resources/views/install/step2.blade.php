              ...
              <div class="col-md-12">
                <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('install.validate') }}">
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label">{{ phrase('Purchase Code') }} | <a style="color:red;" href="https://cutt.ly/PLFZenO" target="_blank">NULLED Web Community</a></label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control eForm-control" name="purchase_code" placeholder="Enter random value"
