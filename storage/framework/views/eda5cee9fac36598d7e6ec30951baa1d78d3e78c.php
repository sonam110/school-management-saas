              ...
              <div class="row mt-2">
                <div class="col-md-12">
                  <div class="alert alert-success" role="alert">
                    <small><?php echo e(get_phrase("Only the server will support email logos and social media icons.Localhost won't support this.")); ?></small>
                  </div>
                </div>
              </div>
            </div>
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ekattor\resources\views/superadmin/settings/system_settings.blade.php ENDPATH**/ ?>